...
namespace TerrainTools
{
    ...
    public static class Keybindings
    {
        ...
        public static bool GridModeDisabled
        {
            get { return !GridModeEnabled; }
        }

        public static bool GridModFreshlyEnabled
        {
            get { var temp = gridModeFreshlyEnabled; gridModeFreshlyEnabled = false; return temp; }
        }

        public static bool GridModFreshlyDisabled
        {
            get { var temp = gridModeFreshlyDisabled; gridModeFreshlyDisabled = false; return temp; }
        }

        public static bool PrecisionModeEnabled { get; private set; } = false;

        public static bool PrecisionModeDisabled
        {
            get { return !PrecisionModeEnabled; }
        }

        public static bool SnapModeEnabled
        {
            get { return !ZInput.GetButton(NoSnapMode) && !ZInput.GetButton(JoyNoSnapMode); }
        }

        public static bool SnapModeDisabled
        {
            get { return !SnapModeEnabled; }
        }
        ...
        public static float ScrollDelta()
        {
            ...
            if (scrollDelta != 0)
            {
                scrollDelta = scrollDelta > 0 ? OrdinaryScrollPrecision : -OrdinaryScrollPrecision;
            }
            else if (ZInput.GetButton(JoyScrollUnlock))
            {
                Debug.Log("DUPA");
                scrollDelta = ZInput.GetButtonDown(JoyScrollUp) ? OrdinaryScrollPrecision : scrollDelta;
                scrollDelta = ZInput.GetButtonDown(JoyScrollDOwn) ? -OrdinaryScrollPrecision : scrollDelta;
            }

            return PrecisionModeDisabled ? scrollDelta : scrollDelta * SuperiorScrollPrecisionMulltiplier;
        }
    }
}