...
public class Overlay
{
    ...
    public float StartSize
    {
        ...
        set { ParticleSystem.MainModule psMain = ps.main; psMain.startSize = value; }
    }
    ...
    public float StartLifetime
    {
        ...
        set { ParticleSystem.MainModule psMain = ps.main; psMain.startLifetime = value; }
    }

    public bool SizeOverLifetimeEnabled
    {
        get { return ps.sizeOverLifetime.enabled; }
        set { ParticleSystem.SizeOverLifetimeModule psSizeOverLifetime = ps.sizeOverLifetime; psSizeOverLifetime.enabled = value; }
    }

    public ParticleSystem.MinMaxCurve SizeOverLifetime
    {
        get { return ps.sizeOverLifetime.size; }
        set { ParticleSystem.SizeOverLifetimeModule psSizeOverLifetime = ps.sizeOverLifetime; psSizeOverLifetime.size = value; }
    }
